...
class DashboardService:
    ...
    def read_metrics(self, user=None):
        ...
        if user:
            ...
            data["user_active_listings"] = Listing.count_by_user(self.db_session, user.user_id)
            data["user_active_loans"] = Loan.count_active_by_user(self.db_session, user.user_id)
